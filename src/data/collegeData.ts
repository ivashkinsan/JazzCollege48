...
export const estradaDepartment: EstradaDepartment = {
  ...
  established: 1981,
  description: "Эстрадное отделение ЛОКИ им. К.Н. Игумнова — одно из ведущих подразделений колледжа, готовящее профессиональных музыкантов и вокалистов для работы в современной эстрадной индустрии.",
  headName: "Заведующий отделением",
  specialties: [
    {
      code: "53.02.02",
      name: "Музыкальное искусство эстрады",
      description: "Подготовка артистов эстрадного искусства в области вокального и инструментального исполнительства",
      profiles: [
    ...
    },
    {
      ...
      description: "Подготовка специалистов по звукооператорскому мастерству для работы в эстрадной индустрии",
      profiles: [
        "Звукорежиссура эстрадных программ",
        "Техническое обеспечение концертных мероприятий"
      ]
    }
  ],
  features: [
...
export const teachers: Teacher[] = [
  ...
  },
  {
    id: "11",
    name: "Леонид Гурьев",
    position: "Доцент Московской консерватории, приглашённый преподаватель",
    specialty: "Духовые инструменты",
    bio: "Проводит мастер-классы в рамках творческой смены «Мечтай, дерзай, твори!»"
  }
];
